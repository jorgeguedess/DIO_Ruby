...
class MyBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create my_book" do
    assert_difference("MyBook.count") do
      post my_books_url, params: { my_book: { author: @my_book.author, description: @my_book.description, rating: @my_book.rating, title: @my_book.title } }
    end
  ...
  test "should update my_book" do
    patch my_book_url(@my_book), params: { my_book: { author: @my_book.author, description: @my_book.description, rating: @my_book.rating, title: @my_book.title } }
