...
## -- criando um hash vazio variavel --
# Hash.new

## -- podemos iniciar com pares CHAVE-VALOR --
# variavel = {chave: 'valor', chave: 'valor'}

## -- adicione um nome item ao hash --
# variavel[:nome inclusão] = "valor a ser add"
...
# nome.delete(:nome a ser exluido)
